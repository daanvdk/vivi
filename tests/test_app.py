...
def test_counter():
    with TestClient(app) as client:
        ...
        assert after_script == (
            ...
            '<ul>'
            '<li>'
            '<a href="/counters" onclick="call(event, true, false, false)" '
            'class="active">'
            'Counters'
            '</a>'
            '</li>'
            '<li>'
            '<a href="/greeter" onclick="call(event, true, false, false)">'
            'Greeter'
            '</a>'
            '</li>'
            '<li>'
            '<a href="/io" onclick="call(event, true, false, false)">IO</a>'
            '</li>'
            '<li>'
            '<a href="/cookies" onclick="call(event, true, false, false)">'
            'Cookies'
            '</a>'
            '</li>'
            '</ul>'
            '<h1>Counter 1</h1>'
            '<div>'
            '<button onclick="call(event, false, false, false)">-</button>'
            ' count: 0 '
            '<button onclick="call(event, false, false, false)">+</button>'
            '</div>'
            '<h1>Counter 2</h1>'
